...
несколько товаров.
Код реализует классы `Smartphone` и `LawnGrass`, наследующие от базового класса `Product`, 
для управления характеристиками и стоимостью продуктов. Операторы сложения переопределены для вычисления 
общей стоимости нескольких экземпляров каждого класса.
Также в данном проекте оптимизируется работа с родительскими классами путем создания абстрактных классов и классов наследников.
